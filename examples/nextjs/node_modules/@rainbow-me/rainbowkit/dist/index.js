...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-OVHMJAIH.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-CUEYA4EA.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-H7XQWAJD.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-LZAJTNZS.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-OPSN3UNU.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-JOG67N4G.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-REJBOBWD.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-ERV7BPO7.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-AI6QAI4A.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-TUYEW2LO.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-NL53U2BH.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-ZJSR4S4G.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-EHQ6UPJQ.js")).default;
    case "zh":
    case "zh-CN":
      return (await import("./zh_CN-REVGEBYC.js")).default;
    default:
      return (await import("./en_US-CUEYA4EA.js")).default;
  }
};
...
import { useAccount as useAccount15, useBalance as useBalance2, useConfig as useConfig4 } from "wagmi";
...
import React12, { createContext as createContext6, useContext as useContext5, useEffect as useEffect6, useState as useState6 } from "react";
import { useAccount as useAccount4, usePublicClient } from "wagmi";
...
function TransactionStoreProvider({
  ...
  const [store] = useState6(() => storeSingleton != null ? storeSingleton : storeSingleton = createTransactionStore({ provider }));
  useEffect6(() => {
...
function useRecentTransactions() {
  ...
  const chainId = useChainId();
  const [transactions, setTransactions] = useState7(() => store && address && chainId ? store.getTransactions(address, chainId) : []);
  useEffect7(() => {
...
import { useAccount as useAccount14, useAccountEffect as useAccountEffect3, useConfig as useConfig3 } from "wagmi";

// src/components/AccountModal/AccountModal.tsx
import React37 from "react";
import { useAccount as useAccount11, useDisconnect } from "wagmi";
...
import { useCallback as useCallback2, useEffect as useEffect9 } from "react";
...
function useFingerprint() {
  const fingerprint = useCallback2(() => {
    setRainbowKitVersion({ version: "2.0.0" });
  }, []);
  useEffect9(() => {
    fingerprint();
  }, [fingerprint]);
...
function useWalletConnectors(mergeEIP6963WithRkConnectors = false) {
  ...
  async function connectWallet(connector) {
    ...
    const result = await connectAsync({
      chainId: (_c2 = intialChainId != null ? intialChainId : (_a2 = rainbowKitChains.find(({ id }) => id === walletChainId)) == null ? void 0 : _a2.id) != null ? _c2 : (_b2 = rainbowKitChains[0]) == null ? void 0 : _b2.id,
      connector
    });
    if (result) {
  ...
  async function connectToWalletConnectModal(walletConnectModalConnector2) {
    try {
      return await connectWallet(walletConnectModalConnector2);
    } catch (err) {
  ...
  for (const wallet of combinedConnectorsWithRecentWallets) {
    ...
    walletConnectors.push({
      ...wallet,
      ready: (_a = wallet.installed) != null ? _a : true,
      connect: () => connectWallet(wallet),
      ...
      getQrCodeUri: ((_b = wallet.qrCode) == null ? void 0 : _b.getUri) ? () => getWalletConnectUri(wallet, wallet.qrCode.getUri) : void 0,
      getDesktopUri: ((_c = wallet.desktop) == null ? void 0 : _c.getUri) ? () => getWalletConnectUri(wallet, wallet.desktop.getUri) : void 0,
      getMobileUri: ((_d = wallet.mobile) == null ? void 0 : _d.getUri) ? () => {
        var _a2;
...
import React22, { useCallback as useCallback3, useContext as useContext7, useRef } from "react";
...
import React24, { useCallback as useCallback5, useEffect as useEffect11, useRef as useRef2 } from "react";
...
function FocusTrap(props) {
  ...
  return /* @__PURE__ */ React24.createElement(React24.Fragment, null, /* @__PURE__ */ React24.createElement("div", {
    onFocus: useCallback5(() => contentRef.current && moveFocusWithin(contentRef.current, "end"), []),
    tabIndex: 0
    ...
    onFocus: useCallback5(() => contentRef.current && moveFocusWithin(contentRef.current, "start"), []),
    tabIndex: 0
  }));
}
...
import React36, { useCallback as useCallback8, useContext as useContext11, useEffect as useEffect13, useState as useState11 } from "react";
...
var Chain = ({
  ...
  return /* @__PURE__ */ React40.createElement(Fragment, null, /* @__PURE__ */ React40.createElement(MenuButton, {
  ...
  }, src7 && /* @__PURE__ */ React40.createElement(Box, {
    height: "full",
    marginRight: "8"
  ...
  })), /* @__PURE__ */ React40.createElement("div", null, name != null ? name : name)), isCurrentChain && /* @__PURE__ */ React40.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    marginRight: "6"
    ...
    marginLeft: "8",
    width: "8"
  })), isLoading && /* @__PURE__ */ React40.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    marginRight: "6"
...
function ChainModal({ onClose, open }) {
  ...
  return /* @__PURE__ */ React41.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React41.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    paddingBottom: "0"
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && /* @__PURE__ */ React41.createElement(Box, {
    width: "30"
  }), /* @__PURE__ */ React41.createElement(Box, {
    paddingBottom: "0",
    paddingLeft: "8",
    ...
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, i18n2.t("chains.title"))), /* @__PURE__ */ React41.createElement(CloseButton, {
    onClose
  })), !isCurrentChainSupported && /* @__PURE__ */ React41.createElement(Box, {
    marginX: "8",
    ...
    size: "14",
    weight: "medium"
  }, i18n2.t("chains.wrong_network"))), /* @__PURE__ */ React41.createElement(Box, {
    ...
    return /* @__PURE__ */ React41.createElement(Chain_default, {
      key: id,
      chainId: id,
  ...
  }), !isCurrentChainSupported && /* @__PURE__ */ React41.createElement(React41.Fragment, null, /* @__PURE__ */ React41.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), /* @__PURE__ */ React41.createElement(MenuButton, {
    onClick: () => disconnect(),
    ...
    justifyContent: "center",
    marginRight: "8"
  }, /* @__PURE__ */ React41.createElement(DisconnectSqIcon, {
...
import { useAccount as useAccount13, useDisconnect as useDisconnect3 } from "wagmi";
...
function ConnectModalIntro({
  ...
  return /* @__PURE__ */ React44.createElement(React44.Fragment, null, /* @__PURE__ */ React44.createElement(Box, {
    alignItems: "center",
    color: "accentColor",
    display: "flex",
    flexDirection: "column",
    ...
    marginBottom: "10"
  }, !compactModeEnabled && /* @__PURE__ */ React44.createElement(Text, {
    color: "modalText",
    size: "18",
    weight: "heavy"
  }, i18n2.t("intro.title"))), /* @__PURE__ */ React44.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React44.createElement(AssetsIcon, null)), /* @__PURE__ */ React44.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.digital_asset.title")), /* @__PURE__ */ React44.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, i18n2.t("intro.digital_asset.description")))), /* @__PURE__ */ React44.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React44.createElement(LoginIcon, null)), /* @__PURE__ */ React44.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, /* @__PURE__ */ React44.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.login.title")), /* @__PURE__ */ React44.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, i18n2.t("intro.login.description"))))), /* @__PURE__ */ React44.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    justifyContent: "center",
    margin: "10"
  }, /* @__PURE__ */ React44.createElement(ActionButton, {
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("intro.learn_more.label")))), Disclaimer && !compactModeEnabled && /* @__PURE__ */ React44.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, /* @__PURE__ */ React44.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
...
var BackIcon = () => /* @__PURE__ */ React45.createElement("svg", {
  fill: "none",
  height: "17",
  viewBox: "0 0 11 17",
  width: "11",
  xmlns: "http://www.w3.org/2000/svg"
}, /* @__PURE__ */ React45.createElement("title", null, "Back"), /* @__PURE__ */ React45.createElement("path", {
...
var InfoIcon = () => /* @__PURE__ */ React46.createElement("svg", {
  fill: "none",
  height: "12",
  viewBox: "0 0 8 12",
  width: "8",
  xmlns: "http://www.w3.org/2000/svg"
}, /* @__PURE__ */ React46.createElement("title", null, "Info"), /* @__PURE__ */ React46.createElement("path", {
...
var ModalSelection = ({
  ...
  return /* @__PURE__ */ React48.createElement(Box, {
    ...
    src: iconUrl,
    width: "28"
  }), /* @__PURE__ */ React48.createElement(Box, null, /* @__PURE__ */ React48.createElement(Box, {
    style: { marginTop: recent ? -2 : void 0 },
    maxWidth: "200"
  }, name), recent && /* @__PURE__ */ React48.createElement(Text, {
...
var ConnectIcon = () => /* @__PURE__ */ React49.createElement(AsyncImage, {
  background: "#515a70",
...
var CreateIcon = () => /* @__PURE__ */ React50.createElement(AsyncImage, {
  background: "#e3a5e8",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var RefreshIcon = () => /* @__PURE__ */ React51.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var ScanIcon = () => /* @__PURE__ */ React52.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
function QRCode({
  ...
  const dots = useMemo7(() => {
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < 3; i++) {
        dots2.push(/* @__PURE__ */ React53.createElement("rect", {
        ...
        if (matrix[i][j]) {
          if (!(i < 7 && j < 7 || i > matrix.length - 8 && j < 7 || i < 7 && j > matrix.length - 8)) {
            if (!(i > matrixMiddleStart && i < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
              dots2.push(/* @__PURE__ */ React53.createElement("circle", {
  ...
  return /* @__PURE__ */ React53.createElement(Box, {
    ...
    src: logoUrl,
    width: logoSize
  })), /* @__PURE__ */ React53.createElement("svg", {
    height: size,
    style: { all: "revert" },
    width: size
  }, /* @__PURE__ */ React53.createElement("title", null, "QR Code"), /* @__PURE__ */ React53.createElement("defs", null, /* @__PURE__ */ React53.createElement("clipPath", {
    id: "clip-wrapper"
  }, /* @__PURE__ */ React53.createElement("rect", {
    height: logoWrapperSize,
    width: logoWrapperSize
  })), /* @__PURE__ */ React53.createElement("clipPath", {
    id: "clip-logo"
  }, /* @__PURE__ */ React53.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    return /* @__PURE__ */ React54.createElement(Box, {
      ...
      size: "14",
      weight: "bold"
    }, name), /* @__PURE__ */ React54.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileAndExtension ? i18n2.t("get.mobile_and_extension.description") : hasMobileAndDesktop ? i18n2.t("get.mobile_and_desktop.description") : hasMobileCompanionApp ? i18n2.t("get.mobile.description") : hasExtension ? i18n2.t("get.extension.description") : null))), /* @__PURE__ */ React54.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React54.createElement(ActionButton, {
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("get.looking_for.title")), /* @__PURE__ */ React54.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, hasQrCode ? /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, /* @__PURE__ */ React54.createElement(QRCode, {
    ...
    wallet: name
  })), !ready && hasExtension ? /* @__PURE__ */ React54.createElement(Box, {
    paddingTop: "20"
  }, /* @__PURE__ */ React54.createElement(ActionButton, {
    href: wallet.extensionDownloadUrl,
    label: i18n2.t("connect.secondary_action.install.label"),
    type: "secondary"
  })) : null, ready && !hasQrCode && /* @__PURE__ */ React54.createElement(React54.Fragment, null, /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
    ...
    textAlign: "center",
    weight: "medium"
  }, i18n2.t("connect.status.confirm"))), /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    color: "modalText",
    display: "flex",
    flexDirection: "row",
    height: "32",
    marginTop: "8"
  }, connectionError ? /* @__PURE__ */ React54.createElement(ActionButton, {
    ...
    color: "modalTextSecondary"
  }, /* @__PURE__ */ React54.createElement(SpinnerIcon, null))))))), /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, ready && secondaryAction && /* @__PURE__ */ React54.createElement(React54.Fragment, null, /* @__PURE__ */ React54.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), /* @__PURE__ */ React54.createElement(ActionButton, {
...
var DownloadOptionsBox = ({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
  ...
  }), isBrowserCard && /* @__PURE__ */ React54.createElement(Box, {
    ...
    src: iconUrl,
    width: "200"
  })))), !isBrowserCard && gradientRgbas && /* @__PURE__ */ React54.createElement(Box, {
    ...
    justifyContent: "center",
    style: { zIndex: 1 }
  }, /* @__PURE__ */ React54.createElement(Box, null, /* @__PURE__ */ React54.createElement(AsyncImage, {
    height: "60",
    src: iconUrl,
    width: "60",
    ...iconBackground ? {
    ...
    size: "14",
    weight: "bold"
  }, title), /* @__PURE__ */ React54.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, description), /* @__PURE__ */ React54.createElement(Box, {
    marginTop: "14",
    width: "max"
  }, /* @__PURE__ */ React54.createElement(ActionButton, {
    href: url,
...
function DownloadOptionsDetail({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    justifyContent: "center",
    width: "full"
  }, extensionDownloadUrl && /* @__PURE__ */ React54.createElement(DownloadOptionsBox, {
    ...
    variant: "browser"
  }), desktopDownloadUrl && /* @__PURE__ */ React54.createElement(DownloadOptionsBox, {
    ...
    variant: "desktop"
  }), mobileDownloadUrl && /* @__PURE__ */ React54.createElement(DownloadOptionsBox, {
...
function DownloadDetail({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, i18n2.t("get_mobile.description"))), /* @__PURE__ */ React54.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? /* @__PURE__ */ React54.createElement(QRCode, {
    logoSize: 0,
    size: 268,
    uri: downloadUrls.qrCode
  }) : null), /* @__PURE__ */ React54.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
...
var stepIcons = {
  ...
  install: (wallet) => /* @__PURE__ */ React54.createElement(AsyncImage, {
...
function InstructionMobileDetail({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    return /* @__PURE__ */ React54.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet)), /* @__PURE__ */ React54.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React54.createElement(Text, {
      ...
      size: "14",
      weight: "bold"
    }, i18n2.t(d.title)), /* @__PURE__ */ React54.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
...
function DesktopOptions({ onClose }) {
  ...
  const [initialWalletStep, setInitialWalletStep] = useState14("NONE" /* None */);
  ...
  switch (walletStep) {
    case "NONE" /* None */:
      walletContent = /* @__PURE__ */ React55.createElement(ConnectModalIntro, {
    ...
    case "LEARN_COMPACT" /* LearnCompact */:
      ...
      break;
    case "GET" /* Get */:
      walletContent = /* @__PURE__ */ React55.createElement(GetDetail, {
        getWalletDownload,
        compactModeEnabled
      });
    ...
    case "CONNECT" /* Connect */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(ConnectDetail, {
        changeWalletStep,
        compactModeEnabled,
        connectionError,
        onClose,
    ...
    case "DOWNLOAD_OPTIONS" /* DownloadOptions */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(DownloadOptionsDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "DOWNLOAD" /* Download */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "INSTRUCTIONS_MOBILE" /* InstructionsMobile */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(InstructionMobileDetail, {
    ...
    case "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(InstructionExtensionDetail, {
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && i18n2.t("get_options.title", {
        wallet: compactModeEnabled ? selectedWallet.shortName || selectedWallet.name : selectedWallet.name
    ...
    case "INSTRUCTIONS_DESKTOP" /* InstructionsDesktop */:
      walletContent = selectedWallet && /* @__PURE__ */ React55.createElement(InstructionDesktopDetail, {
        connectWallet: selectWallet,
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && i18n2.t("get_options.title", {
  ...
  return /* @__PURE__ */ React55.createElement(Box, {
  ...
  }, (compactModeEnabled ? walletStep === "NONE" /* None */ : true) && /* @__PURE__ */ React55.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, compactModeEnabled && Disclaimer && /* @__PURE__ */ React55.createElement(Box, {
    marginLeft: "16",
    width: "28"
  }, /* @__PURE__ */ React55.createElement(InfoButton, {
  ...
  }, i18n2.t("connect.title"))), compactModeEnabled && /* @__PURE__ */ React55.createElement(Box, {
    marginRight: "16"
    ...
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(([groupName, wallets2], index) => wallets2.length > 0 && /* @__PURE__ */ React55.createElement(Fragment2, {
    key: index
  }, groupName ? /* @__PURE__ */ React55.createElement(Box, {
    marginBottom: "8",
    marginTop: "16",
    marginX: "6"
  }, /* @__PURE__ */ React55.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, supportedI18nGroupNames.includes(groupName) ? i18n2.t(`connector_group.${groupName.toLowerCase()}`) : groupName)) : null, /* @__PURE__ */ React55.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, wallets2.map((wallet) => {
    return /* @__PURE__ */ React55.createElement(ModalSelection, {
  ...
  }))))), compactModeEnabled && /* @__PURE__ */ React55.createElement(React55.Fragment, null, /* @__PURE__ */ React55.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
    ...
    size: "14",
    weight: "medium"
  }, i18n2.t("connect.new_to_ethereum.description"))), /* @__PURE__ */ React55.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "4",
    ...
    size: "14",
    weight: "bold"
  }, i18n2.t("connect.new_to_ethereum.learn_more.label"))))))), (compactModeEnabled ? walletStep !== "NONE" /* None */ : true) && /* @__PURE__ */ React55.createElement(React55.Fragment, null, !compactModeEnabled && /* @__PURE__ */ React55.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), /* @__PURE__ */ React55.createElement(Box, {
    ...
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && /* @__PURE__ */ React55.createElement(Text, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), /* @__PURE__ */ React55.createElement(CloseButton, {
    onClose
  })), /* @__PURE__ */ React55.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
var LoadingSpinner = ({ wallet }) => {
  ...
  return /* @__PURE__ */ React56.createElement("svg", {
    ...
    width: "86",
    height: "86"
  }, /* @__PURE__ */ React56.createElement("title", null, "Loading"), /* @__PURE__ */ React56.createElement("rect", {
    x: "3",
    y: "3",
    width,
    height,
...
function WalletButton({
  ...
  return /* @__PURE__ */ React56.createElement(Box, {
    ...
    paddingTop: "10",
    position: "relative"
  }, connecting ? /* @__PURE__ */ React56.createElement(LoadingSpinner, {
    wallet
  }) : null, /* @__PURE__ */ React56.createElement(AsyncImage, {
    background: iconBackground,
    borderRadius: "13",
    ...
    src: iconUrl,
    width: "60"
  })), !connecting ? /* @__PURE__ */ React56.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    textAlign: "center"
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet.ready && " (unsupported)")), wallet.recent && /* @__PURE__ */ React56.createElement(Text, {
    color: "accentColor",
    size: "12",
    weight: "medium"
...
function MobileOptions({ onClose }) {
  ...
  let headerBackButtonLink = null;
  const [walletStep, setWalletStep] = useState15("CONNECT" /* Connect */);
  const { i18n: i18n2 } = useContext19(I18nContext);
  const ios = isIOS();
  switch (walletStep) {
    case "CONNECT" /* Connect */: {
      ...
      walletContent = /* @__PURE__ */ React56.createElement(Box, null, /* @__PURE__ */ React56.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        size: "16",
        weight: "bold"
      }, i18n2.t("intro.title")), /* @__PURE__ */ React56.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
      }, i18n2.t("intro.description")))), /* @__PURE__ */ React56.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, /* @__PURE__ */ React56.createElement(Box, {
        display: "flex",
        gap: "14",
        justifyContent: "center"
      }, /* @__PURE__ */ React56.createElement(ActionButton, {
        label: i18n2.t("intro.get.label"),
        ...
        size: "large",
        type: "secondary"
      }))), Disclaimer && /* @__PURE__ */ React56.createElement(Box, {
        marginTop: "28",
        marginX: "32",
        textAlign: "center"
      }, /* @__PURE__ */ React56.createElement(Disclaimer, {
        Link: DisclaimerLink,
        Text: DisclaimerText
      })));
      break;
    ...
    case "GET" /* Get */: {
      ...
      walletContent = /* @__PURE__ */ React56.createElement(Box, null, /* @__PURE__ */ React56.createElement(Box, {
        ...
        return /* @__PURE__ */ React56.createElement(Box, {
        ...
        }, /* @__PURE__ */ React56.createElement(AsyncImage, {
          background: iconBackground,
          borderColor: "generalBorder",
          borderRadius: "10",
          height: "48",
          ...
          size: "18",
          weight: "bold"
        }, name)), /* @__PURE__ */ React56.createElement(ActionButton, {
          ...
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && /* @__PURE__ */ React56.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
        ...
        size: "16",
        weight: "bold"
      }, i18n2.t("get.looking_for.title")), /* @__PURE__ */ React56.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
  ...
  return /* @__PURE__ */ React56.createElement(Box, {
    ...
    paddingX: "20",
    position: "relative"
  }, headerBackButtonLink && /* @__PURE__ */ React56.createElement(Box, {
    display: "flex",
    position: "absolute",
    style: {
      left: 0,
    ...
    transition: "default",
    type: "button"
  }, /* @__PURE__ */ React56.createElement(BackIcon, null))), /* @__PURE__ */ React56.createElement(Box, {
    marginTop: "4",
    textAlign: "center",
    width: "full"
  }, /* @__PURE__ */ React56.createElement(Text, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), /* @__PURE__ */ React56.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
...
var MobileStatus = ({ onClose }) => {
  ...
  return /* @__PURE__ */ React57.createElement(Box, null, /* @__PURE__ */ React57.createElement(Box, {
    display: "flex",
    paddingBottom: "32",
    justifyContent: "center",
    alignItems: "center",
    ...
    marginTop: "18",
    marginRight: "24"
  }, /* @__PURE__ */ React57.createElement(CloseButton, {
    onClose
  })), /* @__PURE__ */ React57.createElement(Box, {
    width: "60"
  }, /* @__PURE__ */ React57.createElement(WalletButton, {
    onClose,
    wallet: connector,
    connecting: true
  })), /* @__PURE__ */ React57.createElement(Box, {
...
function ConnectOptions({ onClose }) {
  ...
  return isMobile() ? connector ? /* @__PURE__ */ React58.createElement(MobileStatus, {
    onClose
  }) : /* @__PURE__ */ React58.createElement(MobileOptions, {
    onClose
  }) : /* @__PURE__ */ React58.createElement(DesktopOptions, {
    onClose
  });
}
...
function ConnectModal({ onClose, open }) {
  ...
  const { isConnecting } = useAccount13();
  ...
  if (connectionStatus === "disconnected") {
    return /* @__PURE__ */ React59.createElement(Dialog, {
      onClose: onConnectModalCancel,
      open,
      titleId
    }, /* @__PURE__ */ React59.createElement(DialogContent, {
      bottomSheetOnMobile: true,
      padding: "0",
      wide: true
    }, /* @__PURE__ */ React59.createElement(ConnectOptions, {
      onClose: onConnectModalCancel
    })));
  }
  if (connectionStatus === "unauthenticated") {
    return /* @__PURE__ */ React59.createElement(Dialog, {
      ...
      bottomSheetOnMobile: true,
      padding: "0"
    }, /* @__PURE__ */ React59.createElement(SignIn, {
      onClose: onAuthCancel,
...
function ModalProvider({ children }) {
  ...
  return /* @__PURE__ */ React60.createElement(ModalContext.Provider, {
    value: useMemo8(() => ({
      accountModalOpen,
      chainModalOpen,
      connectModalOpen,
  ...
  }, children, /* @__PURE__ */ React60.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), /* @__PURE__ */ React60.createElement(AccountModal, {
    onClose: closeAccountModal,
    open: accountModalOpen
  }), /* @__PURE__ */ React60.createElement(ChainModal, {
...
function ConnectButton({
  ...
  return ready ? /* @__PURE__ */ React62.createElement(ConnectButtonRenderer, null, ({
    ...
    return /* @__PURE__ */ React62.createElement(Box, {
      ...
      transition: "default",
      type: "button"
    }, unsupportedChain ? /* @__PURE__ */ React62.createElement(Box, {
      alignItems: "center",
      display: "flex",
      height: "24",
      paddingX: "4"
    }, i18n2.t("connect_wallet.wrong_network.label")) : /* @__PURE__ */ React62.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
    }, chain.hasIcon ? /* @__PURE__ */ React62.createElement(Box, {
      display: mapResponsiveValue(chainStatus, (value) => value === "full" || value === "icon" ? "block" : "none"),
      height: "24",
      width: "24"
    }, /* @__PURE__ */ React62.createElement(AsyncImage, {
      ...
      src: chain.iconUrl,
      width: "24"
    })) : null, /* @__PURE__ */ React62.createElement(Box, {
    ...
    }, (_c = chain.name) != null ? _c : chain.id)), /* @__PURE__ */ React62.createElement(DropdownIcon, null)), !unsupportedChain && /* @__PURE__ */ React62.createElement(Box, {
      alignItems: "center",
      as: "button",
      ...
      transition: "default",
      type: "button"
    }, account.displayBalance && /* @__PURE__ */ React62.createElement(Box, {
    ...
    }, /* @__PURE__ */ React62.createElement(Avatar, {
    ...
    }, account.displayName), /* @__PURE__ */ React62.createElement(DropdownIcon, null)))))) : /* @__PURE__ */ React62.createElement(Box, {
      as: "button",
      background: "accentColor",
      borderRadius: "connectButton",
      boxShadow: "connectButton",
...
var WalletButton2 = ({ wallet }) => {
  return /* @__PURE__ */ React64.createElement(WalletButtonRenderer, {
    wallet
    ...
    return /* @__PURE__ */ React64.createElement(Box, {
      ...
      gap: "12",
      paddingRight: "6"
    }, /* @__PURE__ */ React64.createElement(Box, null, loading ? /* @__PURE__ */ React64.createElement(SpinnerIcon, null) : /* @__PURE__ */ React64.createElement(AsyncImage, {
      ...
      wallet: connectorName
    }) : connectorName)), connected ? /* @__PURE__ */ React64.createElement(Box, {
      background: "connectionIndicator",
      borderColor: "selectedOptionBorder",
      borderRadius: "full",
      borderStyle: "solid",
